...
public ResponseEntity<CommonApiResponse> addVariant(@RequestBody VariantAddRequest request) {
    return variantResource.addVariant(request);
}

	@GetMapping("/fetch/all")
@Operation(summary = "Api to fetch all active variants")
public ResponseEntity<VariantResponse> fetchAllVariants() {
	...
	@GetMapping("/search")
@Operation(summary = "Api to search variants by name")
public ResponseEntity<VariantResponse> searchVariants(@RequestParam("variantName") String variantName) {
	...
	@PutMapping("/update")
@Operation(summary = "Api to update variant")
public ResponseEntity<CommonApiResponse> updateVariant(@RequestBody VariantAddRequest request) {
